...
gyp ERR! stack Error: Command failed: C:\Users\lechk\AppData\Local\Programs\Python\Python36\python.EXE -c import sys; print "%s.%s.%s" % sys.version_info[:3];
